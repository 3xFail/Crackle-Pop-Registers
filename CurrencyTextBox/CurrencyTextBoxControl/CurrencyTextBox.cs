...
namespace CurrencyTextBoxControl
{
    public class CurrencyTextBox : TextBox
    {
        ...
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.Register(
            ...
            new FrameworkPropertyMetadata( 100000000000M, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault ) ); //100 billion
        ...
        {
            if (IsNumericKey(e.Key) && Number < MaxValue) //100 billion
            {
                e.Handled = true;
